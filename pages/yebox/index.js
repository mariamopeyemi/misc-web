    ...
    <AppStructure>
      <div className=" flex flex-col text-center align-middle h-[auto] pb-[6rem] gap-[4rem] p-[2rem] md:p-[10rem] bg-[#111111]">
        ...
        <Box className="flex items-center  flex-col ">
          ...
          <Typography className="sub-title-nude md:w-[75%] justify-start">
            Our highly skilled product designers, engineers, product managers,
            and product experts create custom software solutions that fit your
            unique needs.
          </Typography>
          ...
          <div className="flex flex-col my-[4rem] gap-[2rem] items-center">
            <img
              src="/img/emptyCube.svg"
              alt="movement"
              className="myDIV w-[100px] h-[100px] md:w-[230px] md:h-[230px] "
            />
          </div>
          <div className="flex relative h-[120px] md:h-[250px] top-[15rem] flex-col my-[4rem] gap-[2rem] items-center">
            <img
              src="/img/cube.png"
              alt="movement"
              className="spinner-slower absolute w-[260px] h-[260px] md:w-[500px] md:h-[500px] "
            />
            <div className="hidden md:flex rand absolute top-[200px]  md:w-[300px] md:h-[300px] items-center  rounded-[50%] ">
              uuiii
            </div>
          </div>
        </Box>
      </div>
      <div className="hidden md:flex faint absolute top-[300px]  md:w-[100px] md:h-[100px] items-center  rounded-[50%] ">
        uuiii
      </div>
      <div className="hidden md:flex faint absolute top-[700px] right-[100px]  md:w-[100px] md:h-[100px] items-center  rounded-[50%] ">
        uuiii
      </div>
      <div className="hidden md:flex faint absolute top-[2100px] right-[100px]  md:w-[120px] md:h-[120px] items-center  rounded-[50%] ">
        uuiii
      </div>

        <div className="flex p-[2rem] pt-[8rem] gap-[4rem] md:px-[10rem] bg-black">
        <AnimateOnScroll>
          ...
          <Box>
            ...
            />
              ...
              alt="movement"
              className="relative left-[-28.5rem] top-[2rem]"
            />
              <img
          ...
          <div className="flex-8 mt-7 flex justify-center items-center relative left-[12rem] top-[-40rem]">
          <Box className = "max-w-[50rem]">
             <Typography className="title-3-green  md:w-[100%] ">
            INCREASE YOUR VELOCITY
          </Typography>
          <Typography className="title-2-light md:w-[100%] ">
            Build, Launch and scale your application across various channels
            within a short time.
          </Typography>
          </Box>
          </div>
      ...
      <div className=" flex flex-row h-[auto]  p-[2rem] gap-[4rem] md:px-[10rem] bg-black">
        ...
        {/* <img
            src="/img/empty2.svg"
            alt="movement"
            className="absolute top-[200px] left-[250px] spinner-slower w-[500px] h-[600px] "
          /> */}
      ...
      <div className=" flex flex-col h-[auto] pb-[6rem]  gap-[4rem] p-[2rem] md:p-[10rem] bg-black">
        <Box className="flex md:w-[50%] gap-4 flex-col">
          ...
          <Typography className="sub-title2-light my-[1rem] md:w-[80%] justify-start">
            We are proud to have partnered with top brands to create and deliver
            high quality solutions and services to meet users needs.
          </Typography>
        </Box>
        <Box className="flex gap-[4rem] md:flex-col flex-row justify-center ">
          <div className="flex flex-col md:flex-row gap-[2rem] md:gap-0 justify-between ">
            <Image
              width="150px"
              height="50px"
              src="/img/kudibarLogo.svg"
              alt="brand logo"
            />
            <Image
              width="150px"
              height="50px"
              src="/img/kennisLogo.svg"
              alt="brand logo"
            />
            <Image
              width="150px"
            ...
            <Image
              width="150px"
              height="50px"
              src="/img/yeboraLogo.svg"
              alt="brand logo"
            />
            <Image
              width="150px"
              height="50px"
              src="/img/xerobugLogo.svg"
              alt="brand logo"
            />
          </div>
          <div className="flex flex-col md:flex-row gap-[2rem] md:gap-0 justify-between ">
      ...
      <div className=" flex flex-col md:flex-row h-[auto]  bg-black">
        <Box className="flex md:w-[60%] gap-4 flex-col p-[2rem] md:p-[10rem] ">
          ...
          <Typography className="title-2-light  ">
            Building our own <br />
            innovations and <br />
            software is also one of our key offerings.
            <br />
          </Typography>
          <div className="w-[200px] mt-[2rem]">
            <LoadingButton
        ...
        <div className="hidden md:flex w-[40%] justify-end">
          <Image
            ...
            width="500px"
            height="600px"
            className="myDIV flex-end absolute"
          />
        </div>
      </div>
      ...
      <div className=" flex flex-col md:flex-row h-[auto] gap-[4rem] p-[2rem] md:px-[10rem] bg-[#000000]">
        <Box className="flex md:w-[70%] gap-4 flex-col">
          ...
          <Typography className="sub-title2-light  md:w-[70%] justify-start">
            Join dozens of corporates, fast-growing startups scaling their
            teams, accessing new market opportunities and building brilliant
            products with Yebox.
          </Typography>
        </Box>
